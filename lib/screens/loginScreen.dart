  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        ...
        Text('Iron Works Mexico', style: GlobalData.textBlack40,),
        MultiProvider(
          providers: [
                      ...
                      if (lfp.user != null && lfp.password != null) {
                        ...
                        if (rest == 1) {
                          SuccesDialog.msgDialog(
                              ...
                              onPress: () async {
                                ...
                                if(value!=null){
                                    ...
                                    message: 'Good to see you again ${value}', type: 1);
                                }else{
                                  NotificationsService.showSnackBar(
                                    message: 'Good to see you again', type: 1);
                                }
                          ...
                          ErrorDialog.msgDialog(
                              ...
                              onPress: () async {
                                String? value = await storage.read(key: 'message');
                                if(value!=null){
                                  NotificationsService.showSnackBar(
